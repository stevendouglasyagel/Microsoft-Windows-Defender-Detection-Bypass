...
var PopupHandler = /** @class */ (function (_super) {
     ...
     * @param locationHash
     */
    PopupHandler.prototype.handleCodeFlow = function (locationHash) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                // Check that location hash isn't empty.
                if (StringUtils.isEmpty(locationHash)) {
                ...
                return [2 /*return*/, this.authModule.handleFragmentResponse(locationHash)];
            });
        });
    };
    /**
...
var PublicClientApplication = /** @class */ (function () {
    ...
    PublicClientApplication.prototype.handleRedirectCodeFlowCallback = function (authCallback) {
        return __awaiter(this, void 0, void 0, function () {
            var err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.handleRedirectCodeFlowResponse()];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
                        err_2 = _a.sent();
                        this.authCallback(err_2);
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/];
                }
            });
    ...
    PublicClientApplication.prototype.handleRedirectCodeFlowResponse = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (!isResponseHash) {
                    ...
                    return [2 /*return*/, this.handleHashCodeFlow(cachedHash)];
                }
                if (!this.config.auth.navigateToLoginRequestUrl) {
                    // We don't need to navigate - check for hash and prepare to process
                    BrowserUtils.clearHash();
                    return [2 /*return*/, this.handleHashCodeFlow(hash)];
                }
                return [2 /*return*/];
            });
        });
    };
    PublicClientApplication.prototype.handleHashCodeFlow = function (responseHash) {
        return __awaiter(this, void 0, void 0, function () {
            var hashUrlString, serverParams, response;
            return __generator(this, function (_a) {
                if (!StringUtils.isEmpty(responseHash)) {
                    hashUrlString = new UrlString(responseHash);
                    serverParams = hashUrlString.getDeserializedHash();
                    response = {
                        code: serverParams.code,
                        userRequestState: serverParams.state
                    };
    ...
    PublicClientApplication.prototype.loginPopupCodeFlow = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            var navigateUrl;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        navigateUrl = _a.sent();
                        // Acquire token with popup
                        return [2 /*return*/, this.popupTokenHelperCodeFlow(navigateUrl)];
                }
            });
        });
    };
    PublicClientApplication.prototype.popupTokenHelperCodeFlow = function (navigateUrl) {
        return __awaiter(this, void 0, void 0, function () {
            var interactionHandler, popupWindow, hash, codeResponse, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        hash = _a.sent();
                        return [4 /*yield*/, interactionHandler.handleCodeFlow(hash)];
                    case 2:
                        codeResponse = _a.sent();
                        this.authCallback(null, codeResponse);
                        return [2 /*return*/, codeResponse];
                    case 3:
                        e_1 = _a.sent();
                        this.cleanRequest();
                        throw e_1;
    ...
    PublicClientApplication.prototype.popupTokenHelper = function (navigateUrl) {
        return __awaiter(this, void 0, void 0, function () {
            var interactionHandler, popupWindow, hash, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
...
export { AuthError, AuthErrorMessage, PublicClientApplication };
