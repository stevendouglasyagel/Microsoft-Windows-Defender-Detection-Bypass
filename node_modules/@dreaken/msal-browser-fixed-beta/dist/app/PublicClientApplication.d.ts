import { Account, AuthenticationParameters, TokenResponse, CodeResponse, TokenRenewParameters } from "@azure/msal-common";
...
export declare class PublicClientApplication {
    ...
    handleRedirectCodeFlowCallback(authCallback: AuthCallback): Promise<void>;
    private handleRedirectCodeFlowResponse;
    private handleHashCodeFlow;
    /**
    ...
    loginPopupCodeFlow(request: AuthenticationParameters): Promise<CodeResponse>;
    private popupTokenHelperCodeFlow;
    /**
